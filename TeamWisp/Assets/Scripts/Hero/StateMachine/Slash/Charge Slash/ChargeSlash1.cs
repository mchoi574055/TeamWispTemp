...
{
    public class ChargeSlash1 : StateMachineBehaviour
    {
        private HeroController heroController;
        
        private const string Anticipation = "Charge Slash1 Anticipation";
        private const string Action = "Charge Slash1 Action";
        private const string Recovery = "Charge Slash1 Recovery";

        private const string Slash2 = "Charge Slash2";
